    ...
    get(uri) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (scopedSettingsSupport) {
                this.uri = uri;
                return (this.promise = new Promise((resolve, _reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function validateTextDocument(connection, document) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        document2Library.get(document.uri).then((library) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!library) {
                return;
            }
            try {
...
documents.onDidChangeContent((event) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
documents.onDidSave((event) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    let settings = yield settingsCache.get(event.document.uri);
...
function triggerValidateDocument(document) {
    ...
    d.trigger(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
connection.onRequest(AllFixesRequest.type, (params) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    let result;
    let uri = params.textDocument.uri;
...
function createTsProgram(tsconfig) {
    let p = tsPrograms.get(tsconfig);
    if (!p) {
        p = tslint_1.Linter.createProgram(tsconfig);
